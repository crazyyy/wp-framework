  ...
  <header role="banner">
    <div class="container">
      <div class="row">
        ...
        <nav class="header--nav col-xl-10 col-lg-10 col-md-10 col-sm-10" role="navigation">
          <ul class="headnav">
            <li><a href="#">menu</a></li>
            <li><a href="#">menu</a></li>
            <li><a href="#">menu</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <article class="col-md-8">
          <h1 class="page-title">Пример контента (рыба)</h1>
        ...
        <aside class="sidebar col-md-4" role="complementary">
          <div class="widget">
            ...
            <ul>
              <li class="cat-item-none"><a href="#">name</a></li>
              <li class="cat-item-none"><a href="#">name</a></li>
              <li class="cat-item-none"><a href="#">name</a></li>
            </ul>
          </div><!-- widget -->
  ...
  <div class="container">
    <div class="row">
      ...
      <p class="copyright col-12">
        © 2018 Собственность. Работает на html2wp easy.
      </p><!-- /copyright -->
