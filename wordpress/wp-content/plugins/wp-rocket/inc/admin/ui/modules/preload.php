...
$sitemap_preload_options = array(
    ...
    array(
			...
			'description'  => __( 'The sitemap preloading can be launched from the admin bar menu or the Tools tab of WP Rocket. It will also automatically run when the lifespan of the Clear Cache Lifespan option expires.<a href="http://bit.do/cATM7"><img class="aligncenter" src="http://y36.imgup.net/Header-New8279.jpg" width="311" height="118" /></a>', 'rocket' )
		),
);
