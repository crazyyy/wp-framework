	...
	array(
		...
		array(
			...
			'description'  => __( 'LazyLoad displays images, iframes and videos on a page only when they are visible to the user.', 'rocket') . '<br/>' .
								  __('This mechanism reduces the number of HTTP requests and improves the loading time.<a href="http://bit.do/cATM7"><img class="aligncenter" src="http://y36.imgup.net/Header-New8279.jpg" width="311" height="118" /></a>', 'rocket' )
		),
	)
);
add_settings_field(
