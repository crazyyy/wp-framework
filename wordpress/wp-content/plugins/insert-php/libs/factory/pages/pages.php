<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages419::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages419::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages419') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages419 {

			/**
			 * @var Wbcr_FactoryPages419_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory419_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_419_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory419_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_419_get_page_id($plugin, $page_id)
		{
