<?php
	...
	if( !class_exists('Wbcr_FactoryForms417_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms417_Bootstrap3FormLayout extends Wbcr_FactoryForms417_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms417_Control $control
			 */
