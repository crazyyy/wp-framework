...
<li id="<?php echo $file['uid']; ?>">
	...
	<div class="hidden save_notice">
		<p><?php _e('The file was added to the exclusion list', 'wp-optimize'); ?></p>
		<p><button class="button button-primary save-exclusions"><?php _e('Save the exclusions', 'wp-optimize'); ?></button></p>
	</div>
