 ...
 * @version       1.0
 */
class Wbcr_FactoryLogger118_PageBase extends \WBCR\Factory_Templates_106\Pages\PageBase {
	...
	public function __construct($plugin)
	{
		...
		$this->page_menu_short_description = __('Plugin debug report', 'wbcr_factory_logger_118');
	...
	public function assets($scripts, $styles)
	{
		...
		$this->scripts->localize('wbcr_factory_logger_118', [
		...
		$buttons = "
            <div class='btn-group'>
                ...
                <a href='#'
                   ...
                   data-working='" . __('Working...', 'wbcr_factory_logger_118') . "'>" . sprintf(__('Clean-up Logs (<span id="wbcr-log-size">%s</span>)', 'wbcr_factory_logger_118'), $this->get_log_size_formatted()) . "
                   </a>
            </div>";
		?>
		<div class="wbcr-factory-page-group-header" style="margin-top:0;">
			<strong><?php _e('Plugin Log', 'wbcr_factory_logger_118') ?></strong>
			<p>
