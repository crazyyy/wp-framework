...
namespace WBCR\Factory_Freemius_143\Premium;

use WBCR\Factory_Freemius_143\Entities\License;
use WBCR\Factory_Freemius_143\Entities\Plugin;
use WBCR\Factory_Freemius_143\Entities\Site;
use WBCR\Factory_Freemius_143\Entities\User;
use WBCR\Factory_456\Premium\Provider as License_Provider;
use Wbcr_Factory456_Plugin;
use WBCR\Factory_Freemius_143\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_143\Api
	 */
	private $site_api;
	...
	/**
	 * @return \WBCR\Factory_Freemius_143\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_143\Api
	 * @throws Exception
	 */
