...
namespace WBCR\Factory_Freemius_154\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory466_Plugin;
use WBCR\Factory_466\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_154\Premium\Provider
	 */
	private $premium;
	...
	{
		if( !$this->premium instanceof \WBCR\Factory_Freemius_154\Premium\Provider ) {
