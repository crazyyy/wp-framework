...
class Step_Form extends Step {
	...
	public function __construct(\WBCR\Factory_Templates_108\Pages\Setup $page)
	{
	...
	protected function render_form(\Wbcr_FactoryForms453_Form $form)
	{
		?>
		<form method="post" id="w-factory-templates-108__setup-form-<?php echo $this->get_id() ?>" class="w-factory-templates-108__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-templates-108__form-buttons">
				<!--<input type="submit" name="skip_button_<?php /*echo $this->get_id() */ ?>" class="button-primary button button-large w-factory-templates-108__skip-button" value="<?php /*_e('Skip', 'wbcr_factory_templates_108') */ ?>">-->
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-templates-108__continue-button" value="<?php _e('Continue', 'wbcr_factory_templates_108') ?>">
			</div>
		</form>
		<?php
	}

	protected function set_form_handler(\Wbcr_FactoryForms453_Form $form)
	{
	...
	public function html()
	{
		...
		<div id="WBCR" class="wrap">
			<div class="wbcr-factory-templates-108-impressive-page-template factory-bootstrap-457 factory-fontawesome-000">
				<div class="w-factory-templates-108-setup__inner-wrap">
