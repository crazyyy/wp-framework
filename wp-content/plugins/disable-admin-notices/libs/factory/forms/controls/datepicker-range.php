<?php
	...
	if( !class_exists('Wbcr_FactoryForms469_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms469_DatepickerRangeControl extends Wbcr_FactoryForms469_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms469_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms469_TextboxControl($options['range_2'], $form, $provider);
