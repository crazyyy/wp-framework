<?php
	...
	if( !class_exists('Wbcr_FactoryForms450_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms450_DatepickerRangeControl extends Wbcr_FactoryForms450_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms450_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms450_TextboxControl($options['range_2'], $form, $provider);
