<?php
	 ...
	 *  // see FactoryForms474_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms474_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms474_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms474_DropdownAndColorsControl extends Wbcr_FactoryForms474_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms474_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms474_RadioColorsControl($options['colors'], $form, $provider);
