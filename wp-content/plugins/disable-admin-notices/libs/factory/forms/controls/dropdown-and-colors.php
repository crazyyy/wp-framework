<?php
	 ...
	 *  // see FactoryForms469_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms469_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms469_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms469_DropdownAndColorsControl extends Wbcr_FactoryForms469_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms469_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms469_RadioColorsControl($options['colors'], $form, $provider);
