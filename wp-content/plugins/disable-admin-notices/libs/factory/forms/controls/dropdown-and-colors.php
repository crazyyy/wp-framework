<?php
	 ...
	 *  // see FactoryForms450_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms450_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms450_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms450_DropdownAndColorsControl extends Wbcr_FactoryForms450_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms450_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms450_RadioColorsControl($options['colors'], $form, $provider);
