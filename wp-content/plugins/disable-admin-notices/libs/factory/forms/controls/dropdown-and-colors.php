<?php
	 ...
	 *  // see FactoryForms453_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms453_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms453_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms453_DropdownAndColorsControl extends Wbcr_FactoryForms453_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms453_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms453_RadioColorsControl($options['colors'], $form, $provider);
