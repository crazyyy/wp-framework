<?php
	 ...
	 *  // see FactoryForms463_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms463_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms463_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms463_DropdownAndColorsControl extends Wbcr_FactoryForms463_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms463_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms463_RadioColorsControl($options['colors'], $form, $provider);
