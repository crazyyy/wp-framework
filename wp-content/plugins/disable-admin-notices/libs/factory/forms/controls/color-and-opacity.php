<?php
	...
	if( !class_exists('Wbcr_FactoryForms474_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms474_ColorAndOpacityControl extends Wbcr_FactoryForms474_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms474_IntegerControl($options['opacity'], $form, $provider);
