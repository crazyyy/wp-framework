<?php
	...
	if( !class_exists('Wbcr_FactoryForms469_PaddingsEditorControl') ) {

		class Wbcr_FactoryForms469_PaddingsEditorControl extends Wbcr_FactoryForms469_Control {
				...
				<div <?php $this->attrs() ?>
					...
					<div class="factory-slider-container">
						<label class="factory-title">
							<?php _e('Select a side and move the slider to set up:', 'wbcr_factory_forms_469') ?>
						</label>
