<?php
	...
	if( !class_exists('Wbcr_FactoryForms463_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms463_TabHolder extends Wbcr_FactoryForms463_Holder {
			 ...
			 * @param FactoryForms463_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms463_HtmlAttributeBuilder();
