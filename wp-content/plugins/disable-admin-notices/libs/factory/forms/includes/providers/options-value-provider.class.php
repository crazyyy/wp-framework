<?php
	...
	if( !class_exists('Wbcr_FactoryForms450_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms450_OptionsValueProvider implements Wbcr_IFactoryForms450_ValueProvider {
