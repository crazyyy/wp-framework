<?php
	...
	if( !class_exists('Wbcr_FactoryForms453_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms453_OptionsValueProvider implements Wbcr_IFactoryForms453_ValueProvider {
