<?php
	...
	if( !class_exists('Wbcr_FactoryForms450_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms450_Control extends Wbcr_FactoryForms450_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms450_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms450_ValueProvider $provider
			 * @return void
			 */
