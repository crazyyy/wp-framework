<?php
	...
	if( !class_exists('Wbcr_FactoryForms463_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms463_Control extends Wbcr_FactoryForms463_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms463_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms463_ValueProvider $provider
			 * @return void
			 */
