<?php
	...
	if( !class_exists('Wbcr_FactoryForms463_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms463_FormLayout extends Wbcr_FactoryForms463_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-463-' . $this->type);
				$this->addCssClass('factory-forms-463-' . $this->name);
			}
