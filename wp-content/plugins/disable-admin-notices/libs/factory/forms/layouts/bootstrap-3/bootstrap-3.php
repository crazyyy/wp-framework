<?php
	...
	if( !class_exists('Wbcr_FactoryForms450_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms450_Bootstrap3FormLayout extends Wbcr_FactoryForms450_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms450_Control $control
			 */
