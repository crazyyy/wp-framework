<?php
	...
	if( !class_exists('Wbcr_FactoryForms469_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms469_Bootstrap3FormLayout extends Wbcr_FactoryForms469_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms469_Control $control
			 */
