<?php
	...
	if( !class_exists('Wbcr_FactoryForms463_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms463_Bootstrap3FormLayout extends Wbcr_FactoryForms463_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms463_Control $control
			 */
