<?php
	...
	if( !class_exists('Wbcr_FactoryForms453_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms453_Bootstrap3FormLayout extends Wbcr_FactoryForms453_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms453_Control $control
			 */
