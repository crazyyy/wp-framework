...
/**
 * Базовый класс для создания нового плагина. Полную реализацию класса смотрите в Wbcr_Factory456_Plugin
 *
 ...
 */
class  Wbcr_Factory456_Base {

	use WBCR\Factory_456\Options;
	 ...
	 * экземпляр класса \WBCR\Factory_456\Entities\Support, для получения информации о сайте плагина.
	 ...
	 * WBCR\Factory_456\Premium\Provider > WBCR\Factory_Freemius_143\Premium\Provider
	 *
	...
	protected $load_factory_modules = [
		['libs/factory/bootstrap', 'factory_bootstrap_457', 'admin'],
		['libs/factory/forms', 'factory_forms_453', 'admin'],
		['libs/factory/pages', 'factory_pages_455', 'admin'],
	];
	...
	/**
	 * Экземпляр класса \WBCR\Factory_456\Entities\Support используется для получения информации
	 ...
	 *
	 * @var \WBCR\Factory_456\Entities\Support
	 */
	protected $support;

	/**
	 * Экземпляр класса \WBCR\Factory_456\Entities\Paths используется для получения информации о
	 * путях плагина. Часто используется для получения путей или ссылок на место хранения плагина
	 * или его входного файла.
	 *
	 * @var \WBCR\Factory_456\Entities\Paths
	 */
	protected $paths;
	...
	public function __construct($plugin_file, $data)
	{
		...
		$this->support = new \WBCR\Factory_456\Entities\Support($this->support_details);
		$this->paths = new \WBCR\Factory_456\Entities\Paths($plugin_file);
	 ...
	 * См. Wbcr_Factory456_Base::has_premium
	 */
	 ...
	 *
	 * @return string Возвращает заголовок плагина. См. Wbcr_Factory456_Base::plugin_title
	 */
	 ...
	 *
	 * @return string Возвращает префикс плагина.См. Wbcr_Factory456_Base::prefix
	 */
	 ...
	 *
	 * @return string Возвращает имя плагина. См. Wbcr_Factory456_Base::plugin_name
	 */
	 ...
	 *
	 * @return string Возвращает версию плагина. См. Wbcr_Factory456_Base::plugin_version
	 */
	 ...
	 *                            Wbcr_Factory456_Base::plugin_data
	 *
	 * @return null
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_456\Entities\Support.
	 *
	 * @return \WBCR\Factory_456\Entities\Support
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_456\Entities\Paths.
	 *
	 * @return \WBCR\Factory_456\Entities\Paths
	 */
	 ...
	 *
	 * @return object Возвращает объект с сырыми данными плагина. См. Wbcr_Factory456_Base::plugin_data
	 */
