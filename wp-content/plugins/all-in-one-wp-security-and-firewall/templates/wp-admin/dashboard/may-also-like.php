...
<div class="aiowps_col aiowps_half_width aiowps_feature_cont">
	...
	<table class="aiowps_feat_table">
		...
		<tr>
			<td></td>
			<td>
				<img src="<?php echo AIO_WP_SECURITY_URL.'/images/plugin-logos/aios-free.png'; ?>" alt="<?php esc_attr_e('All In One WP Security & Firewall Free', 'all-in-one-wp-security-and-firewall'); ?>" width="auto" height="80">
			</td>
			<td>
				<img src="<?php echo AIO_WP_SECURITY_URL.'/images/plugin-logos/aios-premium.png'; ?>" alt="<?php esc_attr_e('All In One WP Security & Firewall Premium', 'all-in-one-wp-security-and-firewall'); ?>" width="auto" height="80">
			</td>
		</tr>
		<tr>
			<td></td>
			...
			<td>
				<a class="button button-primary" href="https://aiosplugin.com/product/all-in-one-wp-security-and-firewall-premium/" target="_blank"><?php _e('Upgrade now', 'all-in-one-wp-security-and-firewall'); ?></a>
			</td>
		</tr>
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text">
				...
				<p><?php echo __('Protect against brute-force attacks and keep bots at bay.', 'all-in-one-wp-security-and-firewall').' '.__('AIOS takes WordPress\' default login security features to a whole new level.', 'all-in-one-wp-security-and-firewall'); ?></p>
				<br>
				<p><?php echo sprintf(__('To see all login security features, visit %s', 'all-in-one-wp-security-and-firewall'), '<a href="https://aiosplugin.com/features" target="_blank">https://aiosplugin.com/features</a>'); ?></p>
			</td>
			<td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text">
				<h4><?php _e('Firewall and file protection feature suite', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php echo __('Protection from the latest exploits.', 'all-in-one-wp-security-and-firewall').' '.__('Activate firewall settings ranging from basic, intermediate and advanced.', 'all-in-one-wp-security-and-firewall').' '.__('Get comprehensive, instant protection with All-in-One Security.', 'all-in-one-wp-security-and-firewall'); ?></p>
				<br>
				<p><?php echo sprintf(__('To see all firewall and file protection features, visit %s', 'all-in-one-wp-security-and-firewall'), '<a href="https://aiosplugin.com/features" target="_blank">https://aiosplugin.com/features</a>'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-yes" aria-label="<?php esc_attr_e('Yes', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text">
				<h4><?php _e('Content protection feature suite', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Eliminate spam and protect your content to dramatically improve your website\'s interactions with search engines.', 'all-in-one-wp-security-and-firewall'); ?></p>
				<br>
				<p><?php echo sprintf(__('To see all content protection features, visit %s', 'all-in-one-wp-security-and-firewall'), '<a href="https://aiosplugin.com/features" target="_blank">https://aiosplugin.com/features</a>'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-yes" aria-label="<?php esc_attr_e('Yes', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text" colspan="3">
				<h4><?php _e('Malware scanning', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Finding out by accident that your site has been infected with malware is too late.', 'all-in-one-wp-security-and-firewall'); ?></p>
				<br>
				<p><?php echo __('Malware can have a dramatic effect on your site\'s search rankings and you may not even know about it.', 'all-in-one-wp-security-and-firewall').' '.__('It can slow your website down, access customer data, send unsolicited emails, change your content or prevent users from accessing it.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
		</tr>
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Automatic malware scanning', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Best-in-class scanning for the latest malware, trojans and spyware 24/7.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Response time monitoring', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('You\'ll know immediately if your website\'s response time is negatively affected.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Up-time monitoring', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php echo __('AIOS checks your website\'s uptime every 5 minutes.', 'all-in-one-wp-security-and-firewall').' '.__('We\'ll notify you straight away if your site/server goes down.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Flexible assignment', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Register and remove websites from the scanning service at any time.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Malware reports', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Reports are available via the \'My Account\' page and directly via email.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text" colspan="3">
				<h4><?php _e('Flexible two-factor authentication', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('With Two-Factor Authentication (TFA) users enter their username and password and a one-time code sent to a device to login.', 'all-in-one-wp-security-and-firewall'); ?></p>
				<br>
				<p><?php _e('TFA is a feature in both our free and premium packages, but AIOS Premium affords whole new levels of control over how TFA is implemented.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
		</tr>
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Authenticator apps', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php echo __('Supports TOTP and HOTP protocols.', 'all-in-one-wp-security-and-firewall').' '.__('TFA Can be used with Google Authenticator, Microsoft Authenticator, Authy and many more.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-yes" aria-label="<?php esc_attr_e('Yes', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Role specific configuration', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Make it compulsory for certain roles e.g. for admin and editor roles.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Require TFA after a set time period', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('For example you could require all admins to have TFA once their accounts are a week old.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Trusted devices - control how often TFA is required', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Ask for TFA after a chosen number of days for trusted devices instead of on every login.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Anti-bot protection', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Option to hide the existence of forms on WooCommerce login pages unless JavaScript is active.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Customise TFA design layout', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Customise the design of TFA so it aligns with your existing web design.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('TFA emergency codes', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Generate a one-time use emergency code to allow access if your device is lost.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('TFA multisite compatibility', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('TFA is Compatible with multisite networks and sub-sites.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-yes" aria-label="<?php esc_attr_e('Yes', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('TFA support for common login forms', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php echo __('Supports WooCommerce, Affiliates-WP and Theme my Login login forms.', 'all-in-one-wp-security-and-firewall');?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-yes" aria-label="<?php esc_attr_e('Yes', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('TFA support for other login forms', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php echo __('Supports Elementor Pro, bbPress and all third-party login forms without any further coding needed.', 'all-in-one-wp-security-and-firewall');?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text" colspan="3">
				<h4><?php _e('Smart 404 blocking', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('404 errors can occur when someone legitimately mistypes a URL, but they\'re also generated by hackers searching for weaknesses in your site.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
		</tr>
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Automatically and permanently blocks bots producing 404s', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('AIOS Premium provides more protection than the competition by automatically and permanently blocking IP addresses of bots and hackers based on how many 404 errors they generate.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('404 error charts', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Handy charts keep you informed of how many 404s have occurred and which IP address or country is producing them.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text" colspan="3">
				<h4><?php _e('Country blocking', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Most malicious attacks come from a handful of countries and so it\'s possible to prevent most attacks with our country blocking tool.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
		</tr>
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Block traffic based on country of origin', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('AIOS Premium utilises an IP database that promises 99.5% accuracy.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Block traffic to specific pages based on country of origin', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Block access to your whole site or on a page-by-page basis.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Whitelist some users from blocked countries', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Whitelist IP addresses or IP ranges even if they are part of a blocked country.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr class="aiowps-main-feature-row">
			<td class="aiowps-feature-text" colspan="3">
				<h4><?php _e('Premium support', 'all-in-one-wp-security-and-firewall'); ?></h4>
			</td>
		</tr>
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Unlimited support', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php _e('Personalised, email support from our team of Security experts, as and when you need it.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
		...
		<tr>
			<td class="aiowps-feature-text">
				<h4><?php _e('Guaranteed response time', 'all-in-one-wp-security-and-firewall'); ?></h4>
				<p><?php echo __('We offer a guaranteed response time of three days.', 'all-in-one-wp-security-and-firewall').' '.__('99% of our Premium customers receive a response to their enquiry within 24 hours during the working week.', 'all-in-one-wp-security-and-firewall'); ?></p>
			</td>
			<td>
				<p><span class="dashicons dashicons-no-alt" aria-label="<?php esc_attr_e('No', 'all-in-one-wp-security-and-firewall'); ?>"></span></p>
			</td>
