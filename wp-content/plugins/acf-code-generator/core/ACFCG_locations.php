...
class ACFCG_Locations {
	...
	*/
	...
	public function get_locations_html() {
		...
		$parent_field_group= new ACFCG_Group( $args );
...
?>
	...
	<div class="acftc-field-code">
		...
		<pre class="line-numbers"><code class="language-php"><?php
			...
			echo htmlspecialchars( "<?php // Upgrade to ACF Code Generator Pro for '" . $location_rule['param'] . "' location support. ?>" ) . "\n";
			echo htmlspecialchars( "<?php // Visit https://tutsocean.com for more information. ?>" ) . "\n";
