 ...
 * Plugin URI: https://www.wpbeaverbuilder.com/wordpress-customizer-export-import-plugin/?utm_source=external&utm_medium=customizer-export&utm_campaign=plugins-page
 * Description: Adds settings export and import functionality to the WordPress customizer.
 * Version: 0.9.7.3
 * Author: The Beaver Builder Team
 * Author URI: https://www.wpbeaverbuilder.com/?utm_source=external&utm_medium=customizer-export&utm_campaign=plugins-page
 * License: GNU General Public License v2.0
 * License URI: https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain: customizer-export-import
 */
define( 'CEI_VERSION', '0.9.7.3' );
