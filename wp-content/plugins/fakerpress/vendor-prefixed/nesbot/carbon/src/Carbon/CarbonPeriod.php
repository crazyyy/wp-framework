...
use FakerPress\ThirdParty\Carbon\Exceptions\EndLessPeriodException;
...
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidPeriodDateException;
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidPeriodParameterException;
use FakerPress\ThirdParty\Carbon\Exceptions\NotACarbonClassException;
use FakerPress\ThirdParty\Carbon\Exceptions\NotAPeriodException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnknownGetterException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnknownMethodException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \FakerPress\ThirdParty\Carbon\Carbon|\FakerPress\ThirdParty\Carbon\CarbonPeriod|\FakerPress\ThirdParty\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \FakerPress\ThirdParty\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \FakerPress\ThirdParty\Carbon\Carbon|\FakerPress\ThirdParty\Carbon\CarbonPeriod|\FakerPress\ThirdParty\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \FakerPress\ThirdParty\Carbon\CarbonInterface
     */
