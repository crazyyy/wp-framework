...
use FakerPress\ThirdParty\Carbon\Exceptions\BadFluentConstructorException;
use FakerPress\ThirdParty\Carbon\Exceptions\BadFluentSetterException;
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidCastException;
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidIntervalException;
use FakerPress\ThirdParty\Carbon\Exceptions\OutOfRangeException;
use FakerPress\ThirdParty\Carbon\Exceptions\ParseErrorException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnitNotConfiguredException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnknownGetterException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnknownSetterException;
use FakerPress\ThirdParty\Carbon\Exceptions\UnknownUnitException;
use FakerPress\ThirdParty\Carbon\Traits\IntervalRounding;
use FakerPress\ThirdParty\Carbon\Traits\IntervalStep;
use FakerPress\ThirdParty\Carbon\Traits\MagicParameter;
use FakerPress\ThirdParty\Carbon\Traits\Mixin;
use FakerPress\ThirdParty\Carbon\Traits\Options;
use FakerPress\ThirdParty\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @var \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @throws \FakerPress\ThirdParty\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \FakerPress\ThirdParty\Symfony\Component\Translation\Translator $translator */
