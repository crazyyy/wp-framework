...
use FakerPress\ThirdParty\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
     ...
     *
     * @return \FakerPress\ThirdParty\Carbon\CarbonImmutable|\FakerPress\ThirdParty\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \FakerPress\ThirdParty\Carbon\CarbonImmutable|\FakerPress\ThirdParty\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \FakerPress\ThirdParty\Carbon\CarbonImmutable|\FakerPress\ThirdParty\Carbon\Carbon $testInstance */
