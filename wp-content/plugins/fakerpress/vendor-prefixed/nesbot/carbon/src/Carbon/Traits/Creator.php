...
use FakerPress\ThirdParty\Carbon\CarbonImmutable;
use FakerPress\ThirdParty\Carbon\CarbonInterface;
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidDateException;
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidFormatException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \FakerPress\ThirdParty\Carbon\CarbonImmutable|\FakerPress\ThirdParty\Carbon\Carbon|null $mock */
     ...
     * @param \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
