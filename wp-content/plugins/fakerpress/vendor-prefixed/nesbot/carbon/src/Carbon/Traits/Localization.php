...
use FakerPress\ThirdParty\Carbon\Exceptions\InvalidTypeException;
use FakerPress\ThirdParty\Carbon\Exceptions\NotLocaleAwareException;
use FakerPress\ThirdParty\Carbon\Language;
use FakerPress\ThirdParty\Carbon\Translator;
use FakerPress\ThirdParty\Carbon\TranslatorStrongTypeInterface;
use Closure;
use FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorBagInterface;
use FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface;
...
if (interface_exists('FakerPress\\ThirdParty\\Symfony\\Contracts\\Translation\\TranslatorInterface') &&
    ...
    class_alias(
        'FakerPress\\ThirdParty\\Symfony\\Contracts\\Translation\\TranslatorInterface',
...
trait Localization
{
     ...
     *
     * @return \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \FakerPress\ThirdParty\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     * @param \FakerPress\ThirdParty\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
