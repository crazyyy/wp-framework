...
namespace FakerPress\ThirdParty\Faker\Provider\ro_RO;
...
class Person extends \FakerPress\ThirdParty\Faker\Provider\Person
{
    ...
    protected function getDateOfBirth($dateOfBirth)
    {
        ...
        $baseDate = \FakerPress\ThirdParty\Faker\Provider\DateTime::dateTimeBetween("first day of January {$dateOfBirthParts[0]}", "last day of December {$dateOfBirthParts[0]}");
