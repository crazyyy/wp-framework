...
use FakerPress\ThirdParty\Faker\DefaultGenerator;
use FakerPress\ThirdParty\Faker\Generator;
use FakerPress\ThirdParty\Faker\UniqueGenerator;
use FakerPress\ThirdParty\Faker\ValidGenerator;

class Base
{
    /**
     * @var \FakerPress\ThirdParty\Faker\Generator
     */
    protected $generator;

    /**
     * @var \FakerPress\ThirdParty\Faker\UniqueGenerator
     */
    protected $unique;
