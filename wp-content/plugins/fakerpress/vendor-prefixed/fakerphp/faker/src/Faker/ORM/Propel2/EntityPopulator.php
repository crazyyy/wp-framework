...
namespace FakerPress\ThirdParty\Faker\ORM\Propel2;
...
class EntityPopulator
{
     ...
     * @return array
     */
    public function guessColumnFormatters(\FakerPress\ThirdParty\Faker\Generator $generator)
    {
        $formatters = [];
        $class = $this->class;
        ...
        $columnTypeGuesser = new \FakerPress\ThirdParty\Faker\ORM\Propel2\ColumnTypeGuesser($generator);
     ...
     * @return array
     */
    public function guessModifiers(\FakerPress\ThirdParty\Faker\Generator $generator)
    {
        $modifiers = [];
        $class = $this->class;
        $peerClass = $class::TABLE_MAP;
