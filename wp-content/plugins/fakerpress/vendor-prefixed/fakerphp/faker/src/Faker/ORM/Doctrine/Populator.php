...
class Populator
{
    ...
    {
        if (!$entity instanceof \FakerPress\ThirdParty\Faker\ORM\Doctrine\EntityPopulator) {
            if (null === $this->manager) {
                throw new \InvalidArgumentException('No entity manager passed to Doctrine Populator.');
            }
            $entity = new \FakerPress\ThirdParty\Faker\ORM\Doctrine\EntityPopulator($this->manager->getClassMetadata($entity));
        }
