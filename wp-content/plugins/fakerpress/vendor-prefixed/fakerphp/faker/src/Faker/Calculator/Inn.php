 ...
 * @see \FakerPress\ThirdParty\Faker\Provider\ru_RU\Company
 */
class Inn
{
    /**
     ...
     * @see \FakerPress\ThirdParty\Faker\Provider\ru_RU\Company::inn10Checksum()
     */
    public static function checksum($inn)
    {
        return \FakerPress\ThirdParty\Faker\Provider\ru_RU\Company::inn10Checksum($inn);
    }
     ...
     * @see \FakerPress\ThirdParty\Faker\Provider\ru_RU\Company::inn10IsValid()
     */
    public static function isValid($inn)
    {
        return \FakerPress\ThirdParty\Faker\Provider\ru_RU\Company::inn10IsValid($inn);
    }
}
