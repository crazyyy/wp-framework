...
class Populator
{
    ...
    public function __construct(\FakerPress\ThirdParty\Faker\Generator $generator, Mandango $mandango)
    {
    ...
    {
        if (!$entity instanceof \FakerPress\ThirdParty\Faker\ORM\Mandango\EntityPopulator) {
            $entity = new \FakerPress\ThirdParty\Faker\ORM\Mandango\EntityPopulator($entity);
        }
