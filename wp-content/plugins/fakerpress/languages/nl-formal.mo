...
<link rel="alternate" type="application/rss+xml" title="Translating WordPress &raquo; Feed" href="https://translate.wordpress.org/feed/" />
<link rel="alternate" type="application/rss+xml" title="Translating WordPress &raquo; Comments Feed" href="https://translate.wordpress.org/comments/feed/" />
...
<link rel='stylesheet' id='wporg-local-navigation-bar-style-css' href='https://translate.wordpress.org/wp-content/mu-plugins/pub-sync/blocks/local-navigation-bar/build/style.css?ver=7f678f170a8e22b0e14ecbd4b695da4d6c1366ac' type='text/css' media='all' />
...
<link rel='stylesheet' id='wp-components-css' href='https://translate.wordpress.org/wp-content/plugins/gutenberg/build/components/style.css?ver=18.0.1' type='text/css' media='all' />
...
<link rel='stylesheet' id='wp-mediaelement-css' href='https://translate.wordpress.org/wp-includes/js/mediaelement/wp-mediaelement.min.css?ver=6.6-alpha-58044' type='text/css' media='all' />
...
.wp-block-wporg-notice{--wp--custom--wporg-notice--color--background:var(--wp--preset--color--acid-green-3,#e2ffed);--wp--custom--wporg-notice--color--text:var(--wp--preset--color--charcoal-1,#1e1e1e);background-color:var(--wp--custom--wporg-notice--color--background);border-radius:2px;color:var(--wp--custom--wporg-notice--color--text);display:grid;gap:.5em;grid-template-columns:auto 1fr;padding:1.25em}.wp-block-wporg-notice.is-info-notice{--wp--custom--wporg-notice--color--background:var(--wp--preset--color--blueberry-4,#eff2ff)}.wp-block-wporg-notice.is-alert-notice{--wp--custom--wporg-notice--color--background:var(--wp--preset--color--lemon-3,#fffdd6)}.wp-block-wporg-notice.is-warning-notice{--wp--custom--wporg-notice--color--background:var(--wp--preset--color--pomegrade-3,#ffe9de)}.wp-block-wporg-notice>*{align-self:start}.wp-block-wporg-notice p:first-child{margin-block-start:0}.wp-block-wporg-notice p:last-child{margin-block-end:0}.wp-block-wporg-notice br:first-child{display:none}.wp-block-wporg-notice.alignleft,.wp-block-wporg-notice.alignright{max-width:calc(var(--wp--style--global--content-size, 680px)*.66)}.wp-block-wporg-notice__icon{align-self:flex-start;background-image:url(/wp-content/mu-plugins/pub-sync/blocks/notice/build/../src/icon/library/tip.svg);background-position:top;background-repeat:no-repeat;background-size:24px 24px;display:flex;height:1.875em;margin-top:1px;width:24px}.is-info-notice .wp-block-wporg-notice__icon{background-image:url(/wp-content/mu-plugins/pub-sync/blocks/notice/build/../src/icon/library/info.svg)}.is-alert-notice .wp-block-wporg-notice__icon{background-image:url(/wp-content/mu-plugins/pub-sync/blocks/notice/build/../src/icon/library/alert.svg)}.is-warning-notice .wp-block-wporg-notice__icon{background-image:url(/wp-content/mu-plugins/pub-sync/blocks/notice/build/../src/icon/library/warning.svg)}.wp-block-wporg-notice__content{align-self:center;font-size:var(--wp--preset--font-size--small)}
</style>
...
<link rel='stylesheet' id='translation-events-css-css' href='https://translate.wordpress.org/wp-content/plugins/wporg-gp-translation-events/assets/css/translation-events.css?ver=1713271441' type='text/css' media='all' />
<link rel='stylesheet' id='wporg-global-fonts-css' href='https://translate.wordpress.org/wp-content/mu-plugins/pub-sync/global-fonts/style.css?ver=1700434933' type='text/css' media='all' />
<link rel='stylesheet' id='wporg-global-header-footer-css' href='https://translate.wordpress.org/wp-content/mu-plugins/pub-sync/blocks/global-header-footer/build/style.css?ver=1709680839' type='text/css' media='all' />
...
<script type="text/javascript" src="https://translate.wordpress.org/wp-content/plugins/gutenberg/build/hooks/index.min.js?ver=3aee234ea7807d8d70bc" id="wp-hooks-js"></script>
<script type="text/javascript" src="https://translate.wordpress.org/wp-content/plugins/gutenberg/build/i18n/index.min.js?ver=5baa98e4345eccc97e24" id="wp-i18n-js"></script>
...
<script type="text/javascript" src="https://translate.wordpress.org/wp-content/plugins/wporg-gp-translation-events/assets/js/translation-events.js?ver=1713188429" id="translation-events-js-js"></script>
...
<script type="text/javascript" src="https://translate.wordpress.org/wp-includes/js/admin-bar.min.js?ver=6.6-alpha-58044" id="admin-bar-js"></script>
	...
	<body class="admin-bar no-customize-support is-classic-theme wporg-make make-polyglots no-js">
		...
		<div id="wpadminbar" class="nojq nojs">
				...
				<ul role='menu' id='wp-admin-bar-top-secondary' class="ab-top-secondary ab-top-menu"><li id='wp-admin-bar-log-in'><a class='ab-item' role="menuitem" href='https://login.wordpress.org/?redirect_to=https%3A%2F%2Ftranslate.wordpress.org%2Fprojects%2Fwp-plugins%2Ffakerpress%2Fstable%2Fnl-formal%2Fdefault%2Fexport-translations%2F%3Fformat%3Dmo&#038;locale=en_US'>Log In</a></li><li id='wp-admin-bar-register'><a class='ab-item' role="menuitem" href='https://login.wordpress.org/register?locale=en_US'>Register</a></li></ul>			</div>
		</div>
...
<nav class="is-responsive global-header__navigation wp-block-navigation is-horizontal is-layout-flex wp-block-navigation-is-layout-flex" aria-label="" 
...
-->
<nav class="is-responsive  is-vertical global-header__search wp-block-navigation is-layout-flex wp-container-core-navigation-is-layout-2 wp-block-navigation-is-layout-flex" aria-label="" 
...
<li id="menu-item-11" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-11"><a href="https://make.wordpress.org/polyglots/?resolved=unresolved">Requests</a></li>
<li id="menu-item-13" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-13"><a href="https://make.wordpress.org/polyglots/category/weekly-chats/">Weekly Chats</a></li>
<li id="menu-item-14" class="current-menu-item menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-14"><a href="https://translate.wordpress.org/">Translate</a></li>
<li id="menu-item-12" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-12"><a href="https://make.wordpress.org/polyglots/handbook/">Handbook</a></li>
</ul></div>			</nav>
			</div>
</header>
...
<nav class="wp-block-group alignfull global-footer__navigation-container is-layout-grid wp-container-core-group-is-layout-2 wp-block-group-is-layout-grid" aria-label="Footer">
	...
	<ul>
		...
		<li><a href="https://mercantile.wordpress.org/">Swag Store <span aria-hidden="true" class="wp-exclude-emoji">↗</span></a></li>
...
<div class="wp-block-group global-footer__logos-container is-layout-flow wp-block-group-is-layout-flow">
	...
	<ul class="wp-block-social-links is-style-logos-only is-layout-flex wp-block-social-links-is-layout-flex">
		...
		<figure class="wp-block-image is-resized global-footer__code_is_poetry">
			<img
				src=https://s.w.org/style/images/code-is-poetry-for-dark-bg.svg				alt="Code is Poetry"
				width="188"
				height="13"
			/>
		</figure> 
...
</footer><script type="text/javascript" id="wp-load-polyfill-importmap">
/* <![CDATA[ */
( HTMLScriptElement.supports && HTMLScriptElement.supports("importmap") ) || document.write( '<script src="https://translate.wordpress.org/wp-includes/js/dist/vendor/wp-polyfill-importmap.min.js?ver=1.8.2"></scr' + 'ipt>' );
/* ]]> */
</script>
<script type="importmap" id="wp-importmap">
{"imports":{"@wordpress\/interactivity":"https:\/\/translate.wordpress.org\/wp-content\/plugins\/gutenberg\/build\/interactivity\/index.min.js?ver=18.0.1"}}
</script>
<script type="module" src="https://translate.wordpress.org/wp-content/plugins/gutenberg/build/interactivity/navigation.min.js?ver=18.0.1-20240308" id="@wordpress/block-library/navigation-js-module"></script>
<link rel="modulepreload" href="https://translate.wordpress.org/wp-content/plugins/gutenberg/build/interactivity/index.min.js?ver=18.0.1" id="@wordpress/interactivity-js-modulepreload">		<script>
			( function() {
...
.wp-container-core-navigation-is-layout-2.wp-container-core-navigation-is-layout-2{flex-direction:column;align-items:flex-start;}.wp-container-core-group-is-layout-2.wp-container-core-group-is-layout-2{grid-template-columns:repeat(auto-fill, minmax(min(150px, 100%), 1fr));container-type:inline-size;}.wp-container-core-group-is-layout-3.wp-container-core-group-is-layout-3{flex-wrap:nowrap;justify-content:flex-start;}
</style>
...
<script type='text/javascript' src='https://translate.wordpress.org/wp-admin/load-scripts.php?c=0&amp;load%5Bchunk_0%5D=thickbox&amp;ver=6.6-alpha-58044'></script>
...
/* <![CDATA[ */
_stq = window._stq || [];
_stq.push([ "view", JSON.parse("{\"v\":\"ext\",\"blog\":\"124342649\",\"post\":\"0\",\"tz\":\"0\",\"srv\":\"translate.wordpress.org\",\"j\":\"1:13.3.1\"}") ]);
...
<script type="text/javascript" src="https://translate.wordpress.org/wp-content/mu-plugins/pub-sync/blocks/global-header-footer/js/view.js?ver=1697687513" id="wporg-global-header-script-js"></script>
<script type="text/javascript">
		jQuery('.glossary-links').prepend('<a href="/projects/wp-plugins/fakerpress/dev/nl-formal/default/export-translations/playground/" style="font-weight: 600;">Translate Live</a> <strong class="separator">•</strong> ');
	</script>	<script>
		( function( $ ) {
			$( function() {
