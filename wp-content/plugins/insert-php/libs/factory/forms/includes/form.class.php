<?php
	...
	add_action('wbcr_factory_forms_463_plugin_created', 'wbcr_factory_forms_463_plugin_created');

	function wbcr_factory_forms_463_plugin_created($plugin)
	{
		$plugin->forms = new Wbcr_FactoryForms463_Manager($plugin);
	}

	if( !class_exists('Wbcr_FactoryForms463_Manager') ) {

		class Wbcr_FactoryForms463_Manager {
			 ...
			 *
			 * @see FactoryForms463_Form::registerControl()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms463_Form::registerHolder()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms463_Form::registerCustomElement()
			 *
			 * @since 1.0.0
			 * @return void
			 */
	...
	if( !class_exists('Wbcr_FactoryForms463_Form') ) {
		/**
		 * An abstraction for forms.
		 */
		class Wbcr_FactoryForms463_Form {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_IFactoryForms463_ValueProvider
			 */
			private $provider;
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms463_FormLayout
			 */
			public $layout;
			 ...
			 */
			public function __construct(array $options, Wbcr_Factory466_Plugin $plugin)
			{
				// register controls once, when the first form is created
				if( !Wbcr_FactoryForms463_Manager::$controls_registered ) {

					do_action('wbcr_factory_forms_463_register_controls', $plugin);

					//if( !empty($plugin) ) {
					do_action('wbcr_factory_forms_463_register_controls_' . $plugin->getPluginName(), $plugin);
					//}

					Wbcr_FactoryForms463_Manager::$controls_registered = true;
				}
				...
				Wbcr_FactoryForms463_Manager::$temper = 'flat';
			}
			 ...
			 *
			 * @since 1.0.0
			 * @param Wbcr_IFactoryForms463_ValueProvider $provider
			 * @return void
			 */
			...
			{
				return apply_filters('wbcr_factory_466_form_items', $this->items, $this->name);
			}
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms463_Control[]
			 */
			 ...
			 * @return Wbcr_FactoryForms463_FormElement|null A form element.
			 */
			 ...
			 * @return Wbcr_FactoryForms463_FormElement[] Created elements.
			 */
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms463_Control A control object.
			 */
			public function createControl($item)
			{
				...
				if( is_array($item) ) {
					...
					$control_data = Wbcr_FactoryForms463_Manager::$registered_controls[$item['type']];
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms463_Holder A control holder object.
			 */
			public function createHolder($item)
			{
				...
				if( is_array($item) ) {
					...
					$holderData = Wbcr_FactoryForms463_Manager::$registered_holders[$item['type']];
			...
			public static function connectAssetsForItem($item)
			{
				...
				if( self::isControl($type) ) {
					$haystack = Wbcr_FactoryForms463_Manager::$registered_controls;
				} elseif( self::isControlHolder($type) ) {
					$haystack = Wbcr_FactoryForms463_Manager::$registered_holders;
				}
