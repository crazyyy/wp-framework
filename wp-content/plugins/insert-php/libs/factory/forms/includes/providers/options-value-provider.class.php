<?php
	...
	if( !class_exists('Wbcr_FactoryForms447_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms447_OptionsValueProvider implements Wbcr_IFactoryForms447_ValueProvider {
