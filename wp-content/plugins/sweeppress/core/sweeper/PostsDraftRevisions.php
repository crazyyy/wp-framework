...
class PostsDraftRevisions extends Sweeper {
	protected $_code = 'posts-draft-revisions';
	...
	public function help() : array {
		$help = array(
			...
			__( "It is not aa good idea to remove revisions while you are still writing the post, in case you need to go back and change things before publishing.", "sweeppress" ),
